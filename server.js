...
//     await pool.query(`DROP TABLE IF EXISTS user_docs CASCADE`);
//     await pool.query(`DROP TABLE IF EXISTS notifications CASCADE`);
//     await pool.query(`DROP TABLE IF EXISTS match_requests CASCADE`);
...
//         partner_marital_status VARCHAR(50) DEFAULT 'unmarried',
...
//       VALUES ('Admin', 'admin@matrimony.com', $1) 
//       ON CONFLICT (email) DO NOTHING
//     `, [hashedPassword]);
    
//     console.log('Database tables created successfully.');
//     console.log('Default admin created - Email: admin@matrimony.com, Password: admin123');
//   } catch(e){ console.error('Error setting up tables', e); }
// })();
...
//     // Insert user with all fields (44 columns, 44 values)
//     const insertQuery = `
//       INSERT INTO users (
//         name, email, password, age, gender, dob, birth_time, birth_place,
//         religion, caste, sub_caste, gothram, star, rasi,
...
//     const values = [
//       name, email, hashed, age || null, gender, dob, birth_time, birth_place,
//       religion, caste, sub_caste, gothram, star, rasi,
//       education, occupation, job_location, income,
//       height || null, weight || null, body_type, complexion, mother_tongue, disability || 'no',
//       father_occupation, mother_occupation, elder_brothers || 0, younger_brothers || 0,
//       elder_sisters || 0, younger_sisters || 0, family_details,
//       partner_education, partner_occupation, partner_income, partner_marital_status || 'unmarried', partner_expectations,
//       phone, whatsapp, address, city, state, pincode, about, interests,
//       profilePhoto, 'pending', now, now
//     ];
